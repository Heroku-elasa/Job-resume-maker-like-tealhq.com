...
const AIGuideModal: React.FC<AIGuideModalProps> = ({ 
  ...
  const moduleTranslations: Record<PageKey, string> = {
    legal_drafter: t('header.legal_drafter'),
    lawyer_finder: t('header.lawyer_finder'),
    news_summarizer: t('header.news_summarizer'),
    case_strategist: t('header.case_strategist'),
    notary_finder: t('header.notary_finder'),
    web_analyzer: t('header.web_analyzer'),
    contract_analyzer: t('header.contract_analyzer'),
    evidence_analyzer: t('header.evidence_analyzer'),
    image_generator: t('header.image_generator'),
