...
import { extractTextFromDocument, analyzeCandidateMatch } from '../services/geminiService';
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                            ...
                            <div 
                                ...
                                className={`p-8 border-2 border-dashed rounded-md cursor-pointer text-center transition-colors ${
                                    isDragActive ? 'border-teal-blue bg-teal-50' : 'border-gray-300 hover:border-teal-blue'
                                }`}
                            >
                                <input {...getInputProps()} />
